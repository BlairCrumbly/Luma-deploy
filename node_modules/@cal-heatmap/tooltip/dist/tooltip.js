(function (global, factory) {
  ...
  var ordinaryToPrimitive$1 = function (input, pref) {
    var fn, val;
    if (pref === 'string' && isCallable$g(fn = input.toString) && !isObject$f(val = call$b(fn, input))) return val;
    if (isCallable$g(fn = input.valueOf) && !isObject$f(val = call$b(fn, input))) return val;
    if (pref !== 'string' && isCallable$g(fn = input.toString) && !isObject$f(val = call$b(fn, input))) return val;
  ...
  */
  ...
  var NEW_ITERATOR_PROTOTYPE = !isObject$8(IteratorPrototype$2) || fails$6(function () {
    var test = {};
  ...
  var speciesConstructor$1 = function (O, defaultConstructor) {
    ...
    var S;
    return C === undefined || isNullOrUndefined$3(S = anObject$5(C)[SPECIES$1]) ? defaultConstructor : aConstructor(S);
  };
  ...
  var safeGetBuiltIn$1 = function (name) {
    if (!DESCRIPTORS) return global$7[name];
